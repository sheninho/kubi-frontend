...
export function CategorynDistrictSelectionModal({ onNext }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            onNext() // Remplacez '/path-vers-nouvelle-page' par votre chemin
        } catch (error) {
...
export default CategorynDistrictSelectionModal;
